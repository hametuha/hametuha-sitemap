...
namespace Hametuha\Sitemap\Styles;


use Hametuha\Sitemap\Pattern\SitemapStylePattern;
...
class SitemapIndexStyle extends SitemapStylePattern {
	...
	protected function do_style() {
		...
		<xsl:template match="/">
			...
			<head>
				<meta charset="UTF-8" />
				<title><?php echo esc_xml( 'Sitemap Index', 'hsm' ); ?></title>
			...
			<div class="sitemap">
				<div class="sitemap-header">
					<h1><?php echo esc_xml( 'Sitemap Index', 'hsm' ); ?></h1>
				</div>
